...
<div class="container">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <a class="btn" href="delete_user.php?id=<?= $u['id'] ?>" onclick="return confirm('Delete this user?')">Delete</a>
            </td>
        </tr>
        <?php endwhile; ?>
    </table>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <a class="btn" href="approve_auction.php?id=<?= $a['id'] ?>">Approve</a>
                <a class="btn" href="reject_auction.php?id=<?= $a['id'] ?>">Reject</a>
            </td>
        </tr>
        <?php endwhile; ?>
    </table>
